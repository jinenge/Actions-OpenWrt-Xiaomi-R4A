...
# 修改openwrt登陆地址,把下面的8.8.8.8修改成你想要的就可以了
...
sed -i "s/OpenWrt /jinenge build $(TZ=UTC-8 date "+%Y.%m.%d") @ jinenyy.vip /g" package/lean/default-settings/files/zzz-default-settings
